...
export default function ChatScreen() {
  ...
  // Fetch the walker's profile to get their name and avatar
  ...
  const renderMessage = ({ item }: { item: any }) => {
    ...
    return (
      <View style={[styles.messageRow, isUser && styles.messageRowUser]}>
        {!isUser && <Avatar source={walkerProfile?.avatarUrl} name={walkerProfile?.name} size="sm" />}
  ...
  const otherUserName = walkerProfile?.name || 'Walker';
  const otherUserAvatar = walkerProfile?.avatarUrl;
  ...
  return (
    ...
    >
      ...
      <View style={styles.header}>
        ...
        <Avatar source={otherUserAvatar} size="sm" />
      ...
      <View style={styles.inputContainer}>
        <TextInput
          ...
          placeholderTextColor={colors.barkLight}
          value={newMessage}
